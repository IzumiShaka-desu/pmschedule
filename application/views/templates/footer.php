...
<script>
	...
	function showDialog(idSchedule) {
		...
		if (schedule.id_response != undefined) {
			...
			const rawUrl = "https://portal.incoe.astra.co.id/checksheet/login/redirectAnonymHandler?a=<?php echo $_SESSION['username']; ?>&b=<?php echo $_SESSION['password']; ?>&c=" + base64Path;
